function [ Color_hist ] = color_hist_short( img, type, patch )
...
para.LBinEdges = 0:para.LBinSize:100; %产生一个从0到100，间隔为para.LBinSize的等间隔数列
para.abBinEdges = -128:para.abBinSize:128; %产生一个从-128到128，间隔为para.abBinSize的等间隔数列
% para.NUM_COLORS = 69;
